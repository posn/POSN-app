 ...
 **/
public class GroupNoFriendItem implements ListViewManageGroupItem
   {
      // view holder class
      ...
      public GroupNoFriendItem(String message)
         {
      ...
      public int getViewType()
         {
            return ManageGroupArrayAdapter.ManageGroupRowType.NO_FRIEND_ITEM.ordinal();
         }
