...
import com.posn.main.main.wall.asynctasks.NewCommentAsyncTask;
import com.posn.main.main.wall.asynctasks.NewWallPostAsyncTask;
...
import com.posn.main.main.wall.comments.CommentActivity;
import com.posn.main.main.wall.listview_items.ListViewPostItem;
import com.posn.main.main.wall.listview_items.PhotoPostItem;
import com.posn.main.main.wall.listview_items.StatusPostItem;
import com.posn.main.main.wall.listview_items.VideoPostItem;
      ...
      public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
         {
            ...
            wallPostData = dataManager.wallPostManager.wallPosts;
            ...
            switch (v.getId())
               {
                  ...
                  case R.id.status_button:
                     ...
                     intent.putExtra("groups", dataManager.userGroupManager.getUserGroupsArrayList());
                  ...
                  case R.id.comment_button:
                     ...
                     // start the activity
                     startActivityForResult(intent, Constants.RESULT_CREATE_COMMENTS);
                     break;
      ...
      public void onActivityResult(int requestCode, int resultCode, Intent data)
         {
            ...
            // check if new comments needs to be processed
            else if(requestCode == Constants.RESULT_CREATE_COMMENTS && resultCode == Activity.RESULT_OK)
               {
                  ArrayList<Comment> newComments = data.getParcelableArrayListExtra("newUserComments");
                  WallPost post = data.getParcelableExtra("post");

                  if(newComments.size() > 0)
                     {
                        new NewCommentAsyncTask(this, post, newComments).execute();
                     }
               }
         }
      ...
      private void createWallPostListViewItem(WallPost post)
         {
            ...
            if (post.friendID.equals(dataManager.userManager.ID))
               {
                  name = dataManager.userManager.firstName + " " + dataManager.userManager.lastName;
               }
            else
               {
                  Friend friend = dataManager.friendManager.currentFriends.get(post.friendID);
                  name = friend.name;
               }
