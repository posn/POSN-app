...
import com.posn.R;
import com.posn.main.main.wall.asynctasks.LoadImageAsyncTask;
import com.posn.datatypes.WallPost;
import com.posn.main.main.wall.WallArrayAdapter.PostType;
import com.posn.main.main.wall.views.SquareImageView;
...
public class PhotoPostItem implements ListViewPostItem
   {
      static class PhotoPostViewHolder
         {
            TextView nameText;
            TextView dateText;
      ...
      public View getView(LayoutInflater inflater, View convertView, ViewGroup parent)
         {
            PhotoPostViewHolder viewHolder;

            if (convertView != null && !(convertView.getTag() instanceof PhotoPostViewHolder))
               {
                  convertView = null;
               }
            ...
            if (convertView == null)
               {
                  ...
                  viewHolder = new PhotoPostViewHolder();
               ...
               {
                  viewHolder = (PhotoPostViewHolder) convertView.getTag();
               }
