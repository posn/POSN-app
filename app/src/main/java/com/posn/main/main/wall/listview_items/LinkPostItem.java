...
public class LinkPostItem implements ListViewPostItem, OnClickListener
   {
      ...
      static class LinkPostViewHolder
         {
            TextView nameText;
            TextView dateText;
            TextView linkText;
      ...
      public View getView(LayoutInflater inflater, View convertView, ViewGroup parent)
         {
            LinkPostViewHolder viewHolder;

            if (convertView != null && !(convertView.getTag() instanceof LinkPostViewHolder))
               {
                  convertView = null;
               }
            ...
            if (convertView == null)
               {
                  ...
                  viewHolder = new LinkPostViewHolder();
               ...
               {
                  viewHolder = (LinkPostViewHolder) convertView.getTag();
               }
