 ...
 **/
public class GroupHeaderItem implements ListViewManageGroupItem
   {
      // view holder class
      ...
      public GroupHeaderItem(String title)
         {
            this.title = title;
         }
      ...
      public int getViewType()
         {
            return ManageGroupArrayAdapter.ManageGroupRowType.HEADER_ITEM.ordinal();
         }
      ...
      public boolean equals(Object o)
         {
            if (!(o instanceof GroupHeaderItem)) return false;
            GroupHeaderItem other = (GroupHeaderItem) o;
