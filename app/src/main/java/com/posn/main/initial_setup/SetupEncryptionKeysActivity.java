            ...
            try
               {
                  ...
                  String key = SymmetricKeyHelper.createKeyFromString(password);

                  // create password verification file contents by encrypting a the string
                  String verificationString = SymmetricKeyHelper.encrypt(key, "POSN - SUCCESS");
                  ...
                  Pair<String, String> keyPair = AsymmetricKeyHelper.generateKeys(numEncryptBits, seed);

                  // set the user's public and private key
                  userManager.publicKey = keyPair.first;
                  userManager.privateKey = keyPair.second;
