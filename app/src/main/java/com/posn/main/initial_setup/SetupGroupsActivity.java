...
import com.posn.R;
import com.posn.main.main.groups.SetupInitialGroupsArrayAdapter;
import com.posn.main.initial_setup.asynctasks.SetupFilesAsyncTask;
            ...
            switch (v.getId())
               {
                  case R.id.add_button:
                     ...
                     if (!UserInterfaceHelper.isEditTextEmpty(groupNameText))
                        {
