                     ...
                     if (checkFields())
                        {
                           ...
                           // create user ID
                           userManager.ID = IDGeneratorHelper.generate(userManager.email);

                           // store the first and last name
                           userManager.firstName = firstName.getText().toString().trim();
                           userManager.lastName = lastName.getText().toString().trim();

                           // store the email address
                           userManager.email = email.getText().toString().trim();

                           // store the phone number
                           userManager.phoneNumber = phone.getText().toString().trim();

                           // store the birthday
                           userManager.birthday = birthday.getText().toString().trim();

                           // store the gender
                           RadioGroup rg = (RadioGroup) findViewById(R.id.radioGroup1);
                           String radioValue = ((RadioButton) this.findViewById(rg.getCheckedRadioButtonId())).getText().toString();
                           userManager.gender = radioValue.trim();
      ...
      public boolean checkFields()
         {
            ...
            if (UserInterfaceHelper.isEditTextEmpty(firstName))
               {
            ...
            // check the last name
            if (UserInterfaceHelper.isEditTextEmpty(lastName))
               {
            ...
            if (UserInterfaceHelper.isEditTextEmpty(phone))
               {
